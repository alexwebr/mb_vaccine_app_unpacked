...
.method private K(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    .line 1
    sget v0, Ld/f/b/f/f;->mtrl_child_content_container:I
...
.method private L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ld/f/b/f/l/i;Ld/f/b/f/l/i;FFFFLandroid/graphics/RectF;)V
    .locals 0

    .line 1
    invoke-direct {p0, p2, p3, p5, p7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ld/f/b/f/l/i;FF)F

    move-result p3

    .line 2
    invoke-direct {p0, p2, p4, p6, p8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ld/f/b/f/l/i;FF)F
...
.method private N(FFZLcom/google/android/material/transformation/FabTransformationBehavior$e;)Landroid/util/Pair;
    ...
    .line 1
    :cond_2
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ld/f/b/f/l/h;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, Ld/f/b/f/l/h;->e(Ljava/lang/String;)Ld/f/b/f/l/i;

    move-result-object p1

    .line 2
    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ld/f/b/f/l/h;

    const-string p3, "translationYCurveUpwards"

    invoke-virtual {p2, p3}, Ld/f/b/f/l/h;->e(Ljava/lang/String;)Ld/f/b/f/l/i;
...
.method private O(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F
    .locals 2
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F
...
.method private P(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F
    .locals 2
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F
...
.method private Q(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F
    .locals 2
...
.method private R(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F
    .locals 2
...
.method private S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ld/f/b/f/l/i;FF)F
    .locals 8

    .line 1
    invoke-virtual {p2}, Ld/f/b/f/l/i;->c()J

    move-result-wide v0

    .line 2
    invoke-virtual {p2}, Ld/f/b/f/l/i;->d()J

    move-result-wide v2

    .line 3
    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ld/f/b/f/l/h;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Ld/f/b/f/l/h;->e(Ljava/lang/String;)Ld/f/b/f/l/i;

    move-result-object p1

    .line 4
    invoke-virtual {p1}, Ld/f/b/f/l/i;->c()J

    move-result-wide v4

    invoke-virtual {p1}, Ld/f/b/f/l/i;->d()J
    ...
    .line 5
    invoke-virtual {p2}, Ld/f/b/f/l/i;->e()Landroid/animation/TimeInterpolator;
    ...
    .line 6
    invoke-static {p3, p4, p1}, Ld/f/b/f/l/a;->a(FFF)F
...
.method private U(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 2
    :cond_0
    instance-of p1, p2, Ld/f/b/f/p/d;

    if-eqz p1, :cond_1

    sget p1, Ld/f/b/f/p/c;->a:I
    ...
    .line 4
    sget-object p3, Ld/f/b/f/l/d;->a:Landroid/util/Property;
    ...
    .line 5
    :cond_3
    sget-object p2, Ld/f/b/f/l/d;->a:Landroid/util/Property;
    ...
    .line 9
    :goto_0
    iget-object p2, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ld/f/b/f/l/h;
    ...
    .line 10
    invoke-virtual {p2, p1}, Ld/f/b/f/l/i;->a(Landroid/animation/Animator;)V
...
.method private V(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 1
    instance-of p7, p2, Ld/f/b/f/p/d;
    ...
    .line 4
    invoke-interface {p2, p1}, Ld/f/b/f/p/d;->setCircularRevealScrimColor(I)V

    .line 5
    :cond_1
    sget-object p1, Ld/f/b/f/p/d$d;->a:Landroid/util/Property;
    ...
    .line 7
    :cond_2
    sget-object p3, Ld/f/b/f/p/d$d;->a:Landroid/util/Property;
    ...
    .line 9
    :goto_0
    invoke-static {}, Ld/f/b/f/l/c;->b()Ld/f/b/f/l/c;
...
.method private W(Landroid/view/View;Landroid/view/View;ZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;)V
    ...
    .line 1
    iget-object v0, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/f/b/f/l/j;

    invoke-direct {p0, p1, p2, v0}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F

    move-result v0

    .line 2
    iget-object v1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/f/b/f/l/j;

    invoke-direct {p0, p1, p2, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F
    ...
    check-cast v1, Ld/f/b/f/l/i;

    .line 5
    iget-object p4, p4, Landroid/util/Pair;->second:Ljava/lang/Object;

    check-cast p4, Ld/f/b/f/l/i;
    ...
    .line 10
    invoke-virtual {v1, v0}, Ld/f/b/f/l/i;->a(Landroid/animation/Animator;)V

    .line 11
    invoke-virtual {p4, p1}, Ld/f/b/f/l/i;->a(Landroid/animation/Animator;)V
...
.method private X(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 1
    invoke-static {p2}, Lb/g/m/t;->t(Landroid/view/View;)F

    move-result p7

    invoke-static {p1}, Lb/g/m/t;->t(Landroid/view/View;)F
...
.method private Y(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;FFLjava/util/List;Ljava/util/List;)V
    ...
    .line 1
    instance-of v1, v8, Ld/f/b/f/p/d;
    ...
    check-cast v13, Ld/f/b/f/p/d;

    .line 3
    iget-object v1, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/f/b/f/l/j;

    invoke-direct {v12, v0, v8, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->O(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F

    move-result v1

    .line 4
    iget-object v2, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/f/b/f/l/j;

    invoke-direct {v12, v0, v8, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->P(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F
    ...
    .line 7
    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Ld/f/b/f/l/h;

    const-string v2, "expansion"

    invoke-virtual {v0, v2}, Ld/f/b/f/l/h;->e(Ljava/lang/String;)Ld/f/b/f/l/i;
    ...
    invoke-direct {v0, v1, v10, v11}, Ld/f/b/f/p/d$e;-><init>(FFF)V

    invoke-interface {v13, v0}, Ld/f/b/f/p/d;->setRevealInfo(Ld/f/b/f/p/d$e;)V

    :cond_1
    if-eqz p4, :cond_2

    .line 9
    invoke-interface {v13}, Ld/f/b/f/p/d;->getRevealInfo()Ld/f/b/f/p/d$e;

    move-result-object v0

    iget v0, v0, Ld/f/b/f/p/d$e;->c:F
    ...
    .line 10
    invoke-static/range {v2 .. v7}, Ld/f/b/f/v/a;->b(FFFFFF)F

    move-result v0

    .line 11
    invoke-static {v13, v1, v10, v0}, Ld/f/b/f/p/a;->a(Ld/f/b/f/p/d;FFF)Landroid/animation/Animator;
    ...
    invoke-direct {v0, v12, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior$d;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Ld/f/b/f/p/d;)V

    invoke-virtual {v9, v0}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    .line 13
    invoke-virtual {v14}, Ld/f/b/f/l/i;->c()J
    ...
    iget v6, v0, Ld/f/b/f/p/d$e;->c:F

    .line 16
    invoke-static {v13, v1, v10, v11}, Ld/f/b/f/p/a;->a(Ld/f/b/f/p/d;FFF)Landroid/animation/Animator;
    ...
    .line 20
    invoke-virtual {v14}, Ld/f/b/f/l/i;->d()J
    ...
    .line 21
    invoke-virtual {v0}, Ld/f/b/f/l/h;->f()J
    ...
    .line 23
    :goto_0
    invoke-virtual {v14, v9}, Ld/f/b/f/l/i;->a(Landroid/animation/Animator;)V
    ...
    .line 25
    invoke-static {v13}, Ld/f/b/f/p/a;->b(Ld/f/b/f/p/d;)Landroid/animation/Animator$AnimatorListener;
...
.method private Z(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 1
    instance-of v0, p2, Ld/f/b/f/p/d;
    ...
    .line 7
    :cond_2
    sget-object p3, Ld/f/b/f/l/e;->b:Landroid/util/Property;
    ...
    invoke-virtual {p2, p4}, Ld/f/b/f/l/h;->e(Ljava/lang/String;)Ld/f/b/f/l/i;

    move-result-object p2

    .line 11
    invoke-virtual {p2, p3}, Ld/f/b/f/l/i;->a(Landroid/animation/Animator;)V
    ...
    invoke-direct {p2, p0, v0, p1}, Lcom/google/android/material/transformation/FabTransformationBehavior$c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Ld/f/b/f/p/d;Landroid/graphics/drawable/Drawable;)V
...
.method private c0(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    .line 1
    iget-object v4, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/f/b/f/l/j;

    invoke-direct {v10, v0, v1, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F

    move-result v4

    .line 2
    iget-object v5, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Ld/f/b/f/l/j;

    invoke-direct {v10, v0, v1, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Ld/f/b/f/l/j;)F
    ...
    .line 10
    invoke-direct/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Ld/f/b/f/l/i;Ld/f/b/f/l/i;FFFFLandroid/graphics/RectF;)V
    ...
    .line 13
    :goto_0
    invoke-virtual {v12, v14}, Ld/f/b/f/l/i;->a(Landroid/animation/Animator;)V

    .line 14
    invoke-virtual {v13, v15}, Ld/f/b/f/l/i;->a(Landroid/animation/Animator;)V
...
.method private d0(Landroid/view/View;)I
    ...
    .line 1
    invoke-static {p1}, Lb/g/m/t;->p(Landroid/view/View;)Landroid/content/res/ColorStateList;
...
.method protected J(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    .line 18
    invoke-static {v0, v13}, Ld/f/b/f/l/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V

...
.method private A(Landroid/widget/AutoCompleteTextView;)V
    ...
    .line 3
    iget-object v0, p0, Lcom/google/android/material/textfield/d;->k:Ld/f/b/f/a0/g;
...
.method private r(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v1}, Lcom/google/android/material/textfield/TextInputLayout;->getBoxBackground()Ld/f/b/f/a0/g;

    move-result-object v1

    .line 4
    sget v2, Ld/f/b/f/b;->colorControlHighlight:I

    invoke-static {p1, v2}, Ld/f/b/f/q/a;->c(Landroid/view/View;I)I
    ...
    .line 5
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->t(Landroid/widget/AutoCompleteTextView;I[[ILd/f/b/f/a0/g;)V
    ...
    .line 6
    invoke-direct {p0, p1, v2, v4, v1}, Lcom/google/android/material/textfield/d;->s(Landroid/widget/AutoCompleteTextView;I[[ILd/f/b/f/a0/g;)V
...
.method private s(Landroid/widget/AutoCompleteTextView;I[[ILd/f/b/f/a0/g;)V
    .locals 5
    ...
    .line 2
    invoke-static {p2, v0, v1}, Ld/f/b/f/q/a;->f(IIF)I
    ...
    .line 6
    invoke-static {p1, p3}, Lb/g/m/t;->o0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 8
    invoke-virtual {p4}, Ld/f/b/f/a0/g;->B()Ld/f/b/f/a0/k;

    move-result-object v4

    invoke-direct {v0, v4}, Ld/f/b/f/a0/g;-><init>(Ld/f/b/f/a0/k;)V
    ...
    invoke-virtual {v0, v4}, Ld/f/b/f/a0/g;->T(Landroid/content/res/ColorStateList;)V
    ...
    .line 15
    invoke-static {p1, p2}, Lb/g/m/t;->o0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    .line 16
    invoke-static {p1, p3, p4, v0, v1}, Lb/g/m/t;->y0(Landroid/view/View;IIII)V

    :goto_0
    return-void
.end method

.method private t(Landroid/widget/AutoCompleteTextView;I[[ILd/f/b/f/a0/g;)V
    .locals 7

    .line 1
    sget v0, Ld/f/b/f/b;->colorSurface:I

    invoke-static {p1, v0}, Ld/f/b/f/q/a;->c(Landroid/view/View;I)I
    ...
    .line 4
    invoke-static {p2, v0, v2}, Ld/f/b/f/q/a;->f(IIF)I
    ...
    invoke-virtual {v1, v6}, Ld/f/b/f/a0/g;->T(Landroid/content/res/ColorStateList;)V
    ...
    .line 7
    invoke-virtual {v1, v0}, Ld/f/b/f/a0/g;->setTint(I)V
    ...
    invoke-direct {p3, v0}, Ld/f/b/f/a0/g;-><init>(Ld/f/b/f/a0/k;)V

    const/4 v0, -0x1

    .line 11
    invoke-virtual {p3, v0}, Ld/f/b/f/a0/g;->setTint(I)V
...
.method private varargs v(I[F)Landroid/animation/ValueAnimator;
    ...
    .line 2
    sget-object v0, Ld/f/b/f/l/a;->a:Landroid/animation/TimeInterpolator;
...
.method private w(FFFI)Ld/f/b/f/a0/g;
    .locals 1

    .line 1
    invoke-static {}, Ld/f/b/f/a0/k;->a()Ld/f/b/f/a0/k$b;

    move-result-object v0

    .line 2
    invoke-virtual {v0, p1}, Ld/f/b/f/a0/k$b;->z(F)Ld/f/b/f/a0/k$b;

    .line 3
    invoke-virtual {v0, p1}, Ld/f/b/f/a0/k$b;->D(F)Ld/f/b/f/a0/k$b;

    .line 4
    invoke-virtual {v0, p2}, Ld/f/b/f/a0/k$b;->r(F)Ld/f/b/f/a0/k$b;

    .line 5
    invoke-virtual {v0, p2}, Ld/f/b/f/a0/k$b;->v(F)Ld/f/b/f/a0/k$b;
    ...
    .line 8
    invoke-static {p2, p3}, Ld/f/b/f/a0/g;->l(Landroid/content/Context;F)Ld/f/b/f/a0/g;

    move-result-object p2

    .line 9
    invoke-virtual {p2, p1}, Ld/f/b/f/a0/g;->setShapeAppearanceModel(Ld/f/b/f/a0/k;)V

    const/4 p1, 0x0

    .line 10
    invoke-virtual {p2, p1, p4, p1, p4}, Ld/f/b/f/a0/g;->V(IIII)V
...
.method a()V
    ...
    sget v1, Ld/f/b/f/d;->mtrl_shape_corner_size_small_component:I
    ...
    sget v2, Ld/f/b/f/d;->mtrl_exposed_dropdown_menu_popup_elevation:I
    ...
    sget v3, Ld/f/b/f/d;->mtrl_exposed_dropdown_menu_popup_vertical_padding:I
    ...
    .line 10
    invoke-direct {p0, v0, v0, v1, v2}, Lcom/google/android/material/textfield/d;->w(FFFI)Ld/f/b/f/a0/g;
    ...
    .line 11
    invoke-direct {p0, v4, v0, v1, v2}, Lcom/google/android/material/textfield/d;->w(FFFI)Ld/f/b/f/a0/g;

    move-result-object v0

    .line 12
    iput-object v3, p0, Lcom/google/android/material/textfield/d;->k:Ld/f/b/f/a0/g;
    ...
    sget v0, Ld/f/b/f/e;->mtrl_dropdown_arrow:I

    goto :goto_0

    :cond_0
    sget v0, Ld/f/b/f/e;->mtrl_ic_arrow_drop_down:I
    ...
    sget v2, Ld/f/b/f/i;->exposed_dropdown_menu_content_description:I

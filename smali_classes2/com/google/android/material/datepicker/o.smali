...
.method static b(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    .line 1
    invoke-static {v0, p0}, Lcom/google/android/material/datepicker/o;->c(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;
...
.method private static c(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    .line 2
    invoke-static {}, Lcom/google/android/material/datepicker/o;->j()Landroid/icu/util/TimeZone;
...
.method static d(Ljava/util/Calendar;)Ljava/util/Calendar;
    ...
    .line 1
    invoke-static {p0}, Lcom/google/android/material/datepicker/o;->l(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method private static e(ILjava/util/Locale;)Ljava/text/DateFormat;
    ...
    .line 2
    invoke-static {}, Lcom/google/android/material/datepicker/o;->h()Ljava/util/TimeZone;
...
.method static f(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    .line 1
    invoke-static {v0, p0}, Lcom/google/android/material/datepicker/o;->e(ILjava/util/Locale;)Ljava/text/DateFormat;
...
.method static k()Ljava/util/Calendar;
    ...
    .line 1
    invoke-static {v0}, Lcom/google/android/material/datepicker/o;->l(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method static n()Ljava/text/SimpleDateFormat;
    .locals 1
    ...
    invoke-static {v0}, Lcom/google/android/material/datepicker/o;->o(Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
...
.method private static o(Ljava/util/Locale;)Ljava/text/SimpleDateFormat;
    .locals 1

    const-string v0, "MMMM, yyyy"

    .line 1
    invoke-static {v0, p0}, Lcom/google/android/material/datepicker/o;->g(Ljava/lang/String;Ljava/util/Locale;)Ljava/text/SimpleDateFormat;

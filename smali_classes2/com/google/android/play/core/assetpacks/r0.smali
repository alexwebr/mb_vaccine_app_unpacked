...
.field private final c:Ld/f/b/g/a/a/d0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/play/core/assetpacks/r0;->f:Ld/f/b/g/a/a/e;

    return-void
.end method

.method constructor <init>(Lcom/google/android/play/core/assetpacks/b0;Ld/f/b/g/a/a/d0;Ld/f/b/g/a/a/d0;Lcom/google/android/play/core/assetpacks/x0;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lcom/google/android/play/core/assetpacks/r0;->c:Ld/f/b/g/a/a/d0;

    iput-object p3, p0, Lcom/google/android/play/core/assetpacks/r0;->d:Ld/f/b/g/a/a/d0;

    iput-object p4, p0, Lcom/google/android/play/core/assetpacks/r0;->e:Lcom/google/android/play/core/assetpacks/x0;
...
.method private final b(Lcom/google/android/play/core/assetpacks/q0;)Ljava/io/File;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/google/android/play/core/assetpacks/b0;->c(Ljava/lang/String;IJLjava/lang/String;)Ljava/io/File;
...
.method public final a(Lcom/google/android/play/core/assetpacks/q0;)V
    ...
    invoke-virtual/range {v10 .. v15}, Lcom/google/android/play/core/assetpacks/b0;->y(Ljava/lang/String;IJLjava/lang/String;)Ljava/io/File;
    ...
    iget-object v5, v1, Lcom/google/android/play/core/assetpacks/r0;->a:[B
    ...
    sget-object v4, Lcom/google/android/play/core/assetpacks/r0;->f:Ld/f/b/g/a/a/e;

    const-string v5, "Resuming central directory from last chunk."

    new-array v6, v14, [Ljava/lang/Object;

    invoke-virtual {v4, v5, v6}, Ld/f/b/g/a/a/e;->c(Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/k2;->c()J

    move-result-wide v3

    invoke-virtual {v0, v15, v3, v4}, Lcom/google/android/play/core/assetpacks/l2;->d(Ljava/io/InputStream;J)V
    ...
    iget v4, v2, Lcom/google/android/play/core/assetpacks/n1;->a:I

    invoke-direct {v0, v3, v4}, Lcom/google/android/play/core/assetpacks/t0;-><init>(Ljava/lang/String;I)V
    ...
    :cond_4
    sget-object v3, Lcom/google/android/play/core/assetpacks/r0;->f:Ld/f/b/g/a/a/e;

    const-string v4, "Resuming zip entry from last chunk during local file header."

    new-array v5, v14, [Ljava/lang/Object;

    invoke-virtual {v3, v4, v5}, Ld/f/b/g/a/a/e;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual/range {v16 .. v21}, Lcom/google/android/play/core/assetpacks/b0;->s(Ljava/lang/String;IJLjava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {v4, v6, v5}, Ld/f/b/g/a/a/e;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :goto_2
    iget-object v3, v1, Lcom/google/android/play/core/assetpacks/r0;->a:[B
    ...
    invoke-virtual {v3, v5, v8}, Ld/f/b/g/a/a/e;->c(Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v4}, Ljava/io/File;->getCanonicalPath()Ljava/lang/String;

    move-result-object v4

    iget v11, v2, Lcom/google/android/play/core/assetpacks/q0;->g:I
    ...
    invoke-virtual/range {v3 .. v9}, Lcom/google/android/play/core/assetpacks/l2;->e(Ljava/lang/String;JJI)V
    ...
    invoke-direct {v3, v4}, Lcom/google/android/play/core/assetpacks/k0;-><init>(Ljava/io/InputStream;)V
    ...
    :cond_d
    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/k0;->b()Lcom/google/android/play/core/assetpacks/r2;

    move-result-object v6

    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/r2;->g()Z

    move-result v7

    if-nez v7, :cond_10

    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/k0;->i()Z

    move-result v7

    if-nez v7, :cond_10

    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/r2;->c()Z
    ...
    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/r2;->i()[B

    move-result-object v7

    invoke-virtual {v0, v7}, Lcom/google/android/play/core/assetpacks/l2;->f([B)V

    new-instance v7, Ljava/io/File;

    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/r2;->d()Ljava/lang/String;
    ...
    invoke-virtual {v3, v7}, Lcom/google/android/play/core/assetpacks/k0;->read([B)I
    ...
    invoke-virtual {v0, v7, v3}, Lcom/google/android/play/core/assetpacks/l2;->h([BLjava/io/InputStream;)V

    :cond_10
    :goto_6
    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/k0;->g()Z
    ...
    sget-object v5, Lcom/google/android/play/core/assetpacks/r0;->f:Ld/f/b/g/a/a/e;

    const-string v7, "Writing central directory metadata."

    new-array v8, v14, [Ljava/lang/Object;

    invoke-virtual {v5, v7, v8}, Ld/f/b/g/a/a/e;->c(Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/r2;->i()[B

    move-result-object v5

    invoke-virtual {v0, v5, v4}, Lcom/google/android/play/core/assetpacks/l2;->h([BLjava/io/InputStream;)V
    ...
    invoke-virtual {v0, v3, v4}, Lcom/google/android/play/core/assetpacks/l2;->g([BI)V
    ...
    :cond_14
    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/r2;->f()I
    ...
    invoke-virtual {v4, v5, v7}, Ld/f/b/g/a/a/e;->c(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v6}, Lcom/google/android/play/core/assetpacks/r2;->e()J

    move-result-wide v5

    invoke-virtual {v3}, Lcom/google/android/play/core/assetpacks/k0;->k()J
    ...
    invoke-direct {v0, v3}, Lcom/google/android/play/core/assetpacks/t0;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/google/android/play/core/assetpacks/l2;->i()Ljava/io/File;
    ...
    invoke-virtual {v0, v3}, Lcom/google/android/play/core/assetpacks/l2;->j(I)V
    :try_end_3
    ...
    invoke-direct {v3, v4, v0, v2}, Lcom/google/android/play/core/assetpacks/t0;-><init>(Ljava/lang/String;Ljava/lang/Exception;I)V

    throw v3

    :cond_18
    :goto_9
    sget-object v0, Lcom/google/android/play/core/assetpacks/r0;->f:Ld/f/b/g/a/a/e;
    ...
    invoke-virtual {v0, v4, v3}, Ld/f/b/g/a/a/e;->f(Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v0, v1, Lcom/google/android/play/core/assetpacks/r0;->c:Ld/f/b/g/a/a/d0;
    ...
    invoke-interface {v0, v3, v4, v5, v6}, Lcom/google/android/play/core/assetpacks/j3;->W0(ILjava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v3, v4}, Ld/f/b/g/a/a/e;->g(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v0, v1, Lcom/google/android/play/core/assetpacks/r0;->d:Ld/f/b/g/a/a/d0;
    ...
    iget-object v6, v1, Lcom/google/android/play/core/assetpacks/r0;->e:Lcom/google/android/play/core/assetpacks/x0;

    invoke-virtual {v6, v3, v2}, Lcom/google/android/play/core/assetpacks/x0;->a(Ljava/lang/String;Lcom/google/android/play/core/assetpacks/n1;)D
    ...
    invoke-virtual {v0, v2}, Lcom/google/android/play/core/assetpacks/v;->h(Lcom/google/android/play/core/assetpacks/AssetPackState;)V
    ...
    :try_start_6
    invoke-static {v3, v4}, Ld/f/b/g/a/a/c0;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V

...
.method public static f()Ljava/util/Map;
    ...
    .line 1
    sget-object v0, Li/b0/x;->c:Li/b0/x;
...
.method public static g(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p0, p1}, Li/b0/f0;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs h([Li/q;)Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {p0, v0}, Li/b0/h0;->n([Li/q;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final i(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Li/b0/g0;->d(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final k(Ljava/util/Map;[Li/q;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static l(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Li/b0/h0;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Li/b0/e0;->c(Li/q;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Li/b0/h0;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    invoke-static {v0}, Li/b0/h0;->i(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p1, p0}, Li/b0/h0;->j(Ljava/util/Map;Ljava/lang/Iterable;)V

    return-object p1
.end method

.method public static final n([Li/q;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    .line 1
    invoke-static {p1, p0}, Li/b0/h0;->k(Ljava/util/Map;[Li/q;)V

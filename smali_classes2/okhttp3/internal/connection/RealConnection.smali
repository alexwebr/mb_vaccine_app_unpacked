...
.field private sink:Lk/d;

.field private socket:Ljava/net/Socket;

.field private source:Lk/e;
...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {p1}, Lk/l;->m(Ljava/net/Socket;)Lk/t;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lk/e;

    .line 11
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;

    invoke-static {p1}, Lk/l;->i(Ljava/net/Socket;)Lk/s;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lk/d;
    :try_end_1
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 21
    invoke-static {v1}, Lk/l;->m(Ljava/net/Socket;)Lk/t;
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 7
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lk/d;

    .line 8
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lk/e;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lk/e;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lk/d;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lk/e;Lk/d;)V

    .line 3
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lk/e;

    invoke-interface {v1}, Lk/t;->timeout()Lk/u;
    ...
    invoke-virtual {v1, v4, v5, v2}, Lk/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lk/u;

    .line 4
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lk/d;

    invoke-interface {v1}, Lk/s;->timeout()Lk/u;
    ...
    .line 11
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lk/t;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Lk/t;ILjava/util/concurrent/TimeUnit;)Z
    ...
    .line 20
    :cond_4
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lk/e;

    invoke-interface {p1}, Lk/e;->c()Lk/c;

    move-result-object p1

    invoke-virtual {p1}, Lk/c;->B()Z

    move-result p1

    if-eqz p1, :cond_5

    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lk/d;
...
.method private startHttp2(I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lk/e;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lk/d;

    invoke-virtual {v0, v1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lk/e;Lk/d;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 28
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:Lk/e;

    .line 29
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lk/d;
...
.method public isHealthy(Z)Z
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lk/e;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lk/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lk/u;

    .line 5
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lk/d;
    ...
    invoke-virtual {v0, v1, v2, p2}, Lk/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lk/u;
    ...
    invoke-direct {p2, p1, p3, v0, v1}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lk/e;Lk/d;)V
...
.method public newWebSocketStreams(Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLk/e;Lk/d;Lokhttp3/internal/connection/StreamAllocation;)V

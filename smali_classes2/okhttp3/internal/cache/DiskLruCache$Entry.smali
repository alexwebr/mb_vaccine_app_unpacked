...
.method snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lk/t;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[Lk/t;[J)V
    :try_end_0
...
.method writeLengths(Lk/d;)V
    ...
    .line 2
    invoke-interface {p1, v5}, Lk/d;->C(I)Lk/d;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lk/d;->h1(J)Lk/d;

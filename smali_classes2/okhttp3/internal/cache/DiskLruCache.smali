...
.method private newJournalWriter()Lk/d;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lk/s;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;Lk/s;)V

    .line 3
    invoke-static {v1}, Lk/l;->c(Lk/s;)Lk/d;
...
.method private readJournal()V
    ...
    invoke-interface {v1, v2}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lk/t;
    ...
    .line 2
    :try_start_0
    invoke-interface {v1}, Lk/e;->r0()Ljava/lang/String;
    ...
    .line 16
    :cond_0
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()Lk/d;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lk/d;
    :try_end_2
...
.method public declared-synchronized close()V
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lk/d;
...
.method declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    .line 25
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lk/d;

    const-string v1, "CLEAN"

    invoke-interface {p1, v1}, Lk/d;->Q(Ljava/lang/String;)Lk/d;

    move-result-object p1

    invoke-interface {p1, v3}, Lk/d;->C(I)Lk/d;
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lk/d;)V

    .line 28
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lk/d;

    invoke-interface {p1, v2}, Lk/d;->C(I)Lk/d;
    ...
    invoke-interface {p1, p2}, Lk/d;->Q(Ljava/lang/String;)Lk/d;
...
.method declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 11
    :cond_3
    iget-object p2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lk/d;

    const-string p3, "DIRTY"

    invoke-interface {p2, p3}, Lk/d;->Q(Ljava/lang/String;)Lk/d;

    move-result-object p2

    const/16 p3, 0x20

    invoke-interface {p2, p3}, Lk/d;->C(I)Lk/d;

    move-result-object p2

    invoke-interface {p2, p1}, Lk/d;->Q(Ljava/lang/String;)Lk/d;
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 9
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Lk/d;

    const-string v2, "READ"

    invoke-interface {v1, v2}, Lk/d;->Q(Ljava/lang/String;)Lk/d;

    move-result-object v1

    const/16 v2, 0x20

    invoke-interface {v1, v2}, Lk/d;->C(I)Lk/d;

    move-result-object v1

    invoke-interface {v1, p1}, Lk/d;->Q(Ljava/lang/String;)Lk/d;

    move-result-object p1

    const/16 v1, 0xa

    invoke-interface {p1, v1}, Lk/d;->C(I)Lk/d;
...
.method declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Lk/s;
    ...
    .line 4
    invoke-interface {v0, v1}, Lk/d;->Q(Ljava/lang/String;)Lk/d;
    ...
    invoke-interface {v0, v3, v4}, Lk/d;->h1(J)Lk/d;
    ...
    .line 8
    invoke-interface {v0, v2}, Lk/d;->C(I)Lk/d;
    ...
    .line 11
    invoke-interface {v0, v4}, Lk/d;->Q(Ljava/lang/String;)Lk/d;

    move-result-object v4

    invoke-interface {v4, v5}, Lk/d;->C(I)Lk/d;

    .line 12
    iget-object v3, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;

    invoke-interface {v0, v3}, Lk/d;->Q(Ljava/lang/String;)Lk/d;
    ...
    .line 16
    invoke-virtual {v3, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Lk/d;)V
...
.method removeEntry(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    invoke-interface {v0, v2}, Lk/d;->Q(Ljava/lang/String;)Lk/d;

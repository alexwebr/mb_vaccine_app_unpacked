...
.method public static key(Lokhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lk/f;->r(Ljava/lang/String;)Lk/f;
...
.method static readInt(Lk/e;)I
    .locals 5

    .line 1
    :try_start_0
    invoke-interface {p0}, Lk/e;->L()J

    move-result-wide v0

    .line 2
    invoke-interface {p0}, Lk/e;->r0()Ljava/lang/String;
...
.method get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v0, v3}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)Lk/t;

    move-result-object v3

    invoke-direct {v2, v3}, Lokhttp3/Cache$Entry;-><init>(Lk/t;)V
    :try_end_1

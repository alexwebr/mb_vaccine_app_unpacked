...
.method public static http2HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_METHOD:Lk/f;

    invoke-virtual {p0}, Lokhttp3/Request;->method()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/Header;-><init>(Lk/f;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_PATH:Lk/f;
    ...
    sget-object v4, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lk/f;

    invoke-direct {v3, v4, v2}, Lokhttp3/internal/http2/Header;-><init>(Lk/f;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_SCHEME:Lk/f;
    ...
    invoke-direct {v2, v3, p0}, Lokhttp3/internal/http2/Header;-><init>(Lk/f;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lk/f;->r(Ljava/lang/String;)Lk/f;
    ...
    invoke-direct {v4, v3, v5}, Lokhttp3/internal/http2/Header;-><init>(Lk/f;Ljava/lang/String;)V
...
.method public createRequestBody(Lokhttp3/Request;J)Lk/s;
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->getSink()Lk/s;
...
.method public finishRequest()V
    ...
    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->getSink()Lk/s;
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v3}, Lokhttp3/internal/http2/Http2Stream;->getSource()Lk/t;

    move-result-object v3

    invoke-direct {p1, p0, v3}, Lokhttp3/internal/http2/Http2Codec$StreamFinishingSource;-><init>(Lokhttp3/internal/http2/Http2Codec;Lk/t;)V
...
.method public writeRequestHeaders(Lokhttp3/Request;)V
    ...
    .line 5
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->readTimeout()Lk/u;
    ...
    invoke-virtual {p1, v0, v1, v2}, Lk/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lk/u;

    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;

    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->writeTimeout()Lk/u;

...
.method constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iget-object v3, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lk/d;

    iget-boolean v4, v0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/Http2Writer;-><init>(Lk/d;Z)V
    ...
    iget-object v1, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lk/e;

    iget-boolean v4, v0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v3, v1, v4}, Lokhttp3/internal/http2/Http2Reader;-><init>(Lk/e;Z)V
...
.method pushDataLater(ILk/e;IZ)V
    .locals 8
    ...
    .line 2
    invoke-interface {p2, v0, v1}, Lk/e;->f1(J)V

    .line 3
    invoke-interface {p2, v5, v0, v1}, Lk/t;->read(Lk/c;J)J
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/http2/Http2Connection$5;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILk/c;IZ)V
...
.method public writeData(IZLk/c;J)V
    ...
    invoke-virtual {p4, p2, p1, p3, v0}, Lokhttp3/internal/http2/Http2Writer;->data(ZILk/c;I)V
    ...
    :goto_2
    invoke-virtual {v4, v5, p1, p3, v3}, Lokhttp3/internal/http2/Http2Writer;->data(ZILk/c;I)V

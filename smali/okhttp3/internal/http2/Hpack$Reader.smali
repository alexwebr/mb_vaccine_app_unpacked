...
# direct methods
.method constructor <init>(IILk/t;)V
    .locals 1
    ...
    .line 10
    invoke-static {p3}, Lk/l;->d(Lk/t;)Lk/e;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lk/e;

    return-void
.end method

.method constructor <init>(ILk/t;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p1, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(IILk/t;)V
...
.method private getName(I)Lk/f;
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Lk/f;
...
.method private readByte()I
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lk/e;
...
.method private readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lk/f;

    move-result-object p1

    .line 2
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lk/f;
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lk/f;Lk/f;)V
...
.method private readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-static {v0}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lk/f;)Lk/f;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lk/f;Lk/f;)V
...
.method private readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lk/f;Lk/f;)V
...
.method private readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lk/f;Lk/f;)V
...
.method readByteString()Lk/f;
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lk/e;

    int-to-long v3, v0

    invoke-interface {v2, v3, v4}, Lk/e;->z0(J)[B
    ...
    .line 4
    :cond_1
    iget-object v1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lk/e;

    int-to-long v2, v0

    invoke-interface {v1, v2, v3}, Lk/e;->j(J)Lk/f;

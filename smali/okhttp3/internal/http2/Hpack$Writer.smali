...
# direct methods
.method constructor <init>(IZLk/c;)V
    .locals 1
    ...
    .line 11
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lk/c;
...
.method constructor <init>(Lk/c;)V
    ...
    .line 1
    invoke-direct {p0, v0, v1, p1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLk/c;)V
...
.method writeByteString(Lk/f;)V
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(Lk/f;)I
    ...
    invoke-virtual {v2, p1, v0}, Lokhttp3/internal/http2/Huffman;->encode(Lk/f;Lk/d;)V
    ...
    .line 6
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lk/c;
...
.method writeHeaders(Ljava/util/List;)V
    ...
    .line 9
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:Lk/f;

    invoke-virtual {v4}, Lk/f;->R()Lk/f;

    move-result-object v4

    .line 10
    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:Lk/f;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/Header;->value:Lk/f;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->name:Lk/f;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->value:Lk/f;
    ...
    .line 21
    iget-object v7, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lk/c;

    invoke-virtual {v7, v6}, Lk/c;->i0(I)Lk/c;

    .line 22
    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lk/f;)V

    .line 23
    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(Lk/f;)V
    ...
    .line 25
    :cond_9
    sget-object v7, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:Lk/f;

    invoke-virtual {v4, v7}, Lk/f;->O(Lk/f;)Z

    move-result v7

    if-eqz v7, :cond_a

    sget-object v7, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:Lk/f;
...
.method writeInt(III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:Lk/c;

    or-int/2addr p1, p3

    invoke-virtual {p2, p1}, Lk/c;->i0(I)Lk/c;
    ...
    invoke-virtual {v0, p3}, Lk/c;->i0(I)Lk/c;
    ...
    invoke-virtual {v0, p2}, Lk/c;->i0(I)Lk/c;

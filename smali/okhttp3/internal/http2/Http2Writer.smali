...
.field private final hpackBuffer:Lk/c;
...
.method constructor <init>(Lk/d;Z)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lk/d;
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lk/c;

    .line 5
    new-instance p2, Lokhttp3/internal/http2/Hpack$Writer;

    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(Lk/c;)V
...
.method private writeContinuationFrames(IJ)V
    ...
    .line 3
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lk/d;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lk/c;

    invoke-interface {v0, v1, v4, v5}, Lk/s;->write(Lk/c;J)V
...
.method private static writeMedium(Lk/d;I)V
    ...
    .line 1
    invoke-interface {p0, v0}, Lk/d;->C(I)Lk/d;
    ...
    .line 3
    invoke-interface {p0, p1}, Lk/d;->C(I)Lk/d;
...
.method public declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 6
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lk/d;
...
.method public declared-synchronized connectionPreface()V
    ...
    sget-object v4, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lk/f;

    invoke-virtual {v4}, Lk/f;->t()Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lk/f;

    invoke-virtual {v1}, Lk/f;->S()[B

    move-result-object v1

    invoke-interface {v0, v1}, Lk/d;->K0([B)Lk/d;
...
.method public declared-synchronized data(ZILk/c;I)V
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IBLk/c;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method dataFrame(IBLk/c;I)V
    ...
    invoke-interface {p1, p3, v0, v1}, Lk/s;->write(Lk/c;J)V
...
.method public frameHeader(IIBB)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/http2/Http2Writer;->writeMedium(Lk/d;I)V

    .line 4
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lk/d;
    ...
    invoke-interface {p2, p1}, Lk/d;->v(I)Lk/d;
...
.method public declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lk/d;->v(I)Lk/d;
    ...
    invoke-interface {p1, p2}, Lk/d;->v(I)Lk/d;
    ...
    invoke-interface {p1, p3}, Lk/d;->K0([B)Lk/d;
...
.method headers(ZILjava/util/List;)V
    ...
    .line 7
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lk/c;
    ...
    invoke-interface {p1, p3, v2, v3}, Lk/s;->write(Lk/c;J)V
...
.method public declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lk/d;->v(I)Lk/d;
...
.method public declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 6
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lk/d;

    const v2, 0x7fffffff

    and-int/2addr p2, v2

    invoke-interface {p3, p2}, Lk/d;->v(I)Lk/d;
    ...
    invoke-interface {p2, p3, v4, v5}, Lk/s;->write(Lk/c;J)V
...
.method public declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    .line 5
    :goto_1
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lk/d;

    invoke-interface {v3, v0}, Lk/d;->p(I)Lk/d;
    ...
    invoke-interface {v0, v3}, Lk/d;->v(I)Lk/d;

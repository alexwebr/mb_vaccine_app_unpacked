...
# direct methods
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Lk/e;Lk/d;)V
    .locals 2
    ...
    .line 6
    iput-object p3, p0, Lokhttp3/internal/http1/Http1Codec;->source:Lk/e;

    .line 7
    iput-object p4, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lk/d;
...
.method private readHeaderLine()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->source:Lk/e;

    iget-wide v1, p0, Lokhttp3/internal/http1/Http1Codec;->headerLimit:J

    invoke-interface {v0, v1, v2}, Lk/e;->M(J)Ljava/lang/String;
...
.method public createRequestBody(Lokhttp3/Request;J)Lk/s;
    .locals 2
    ...
    .line 2
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSink()Lk/s;
    ...
    .line 3
    invoke-virtual {p0, p2, p3}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSink(J)Lk/s;
...
.method detachTimeout(Lk/i;)V
    .locals 2

    .line 1
    invoke-virtual {p1}, Lk/i;->a()Lk/u;

    move-result-object v0

    .line 2
    sget-object v1, Lk/u;->NONE:Lk/u;

    invoke-virtual {p1, v1}, Lk/i;->b(Lk/u;)Lk/i;
...
.method public finishRequest()V
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lk/d;
...
.method public newChunkedSink()Lk/s;
    .locals 3
...
.method public newChunkedSource(Lokhttp3/HttpUrl;)Lk/t;
    .locals 2
...
.method public newFixedLengthSink(J)Lk/s;
    .locals 2
...
.method public newFixedLengthSource(J)Lk/t;
    .locals 2
...
.method public newUnknownLengthSource()Lk/t;
    .locals 3
...
.method public openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    .line 4
    invoke-virtual {p0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lk/t;
    ...
    invoke-direct {v3, v0, v1, v2, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLk/e;)V
    ...
    invoke-virtual {p0, p1}, Lokhttp3/internal/http1/Http1Codec;->newChunkedSource(Lokhttp3/HttpUrl;)Lk/t;
    ...
    invoke-direct {v1, v0, v2, v3, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLk/e;)V
    ...
    .line 10
    invoke-virtual {p0, v4, v5}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lk/t;
    ...
    invoke-direct {v1, v0, v4, v5, p1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLk/e;)V
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http1/Http1Codec;->newUnknownLengthSource()Lk/t;

    move-result-object v1

    invoke-static {v1}, Lk/l;->d(Lk/t;)Lk/e;

    move-result-object v1

    invoke-direct {p1, v0, v2, v3, v1}, Lokhttp3/internal/http/RealResponseBody;-><init>(Ljava/lang/String;JLk/e;)V
...
.method public writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lk/d;->Q(Ljava/lang/String;)Lk/d;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lk/d;->Q(Ljava/lang/String;)Lk/d;
    ...
    .line 4
    iget-object v2, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lk/d;

    invoke-virtual {p1, p2}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v3}, Lk/d;->Q(Ljava/lang/String;)Lk/d;
    ...
    .line 7
    invoke-interface {v2, v0}, Lk/d;->Q(Ljava/lang/String;)Lk/d;
    ...
    .line 8
    :cond_0
    iget-object p1, p0, Lokhttp3/internal/http1/Http1Codec;->sink:Lk/d;

    invoke-interface {p1, v0}, Lk/d;->Q(Ljava/lang/String;)Lk/d;

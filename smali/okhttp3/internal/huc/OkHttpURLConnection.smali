...
.method private buildCall()Lokhttp3/Call;
    ...
    .line 19
    :goto_3
    invoke-virtual {v0}, Lokhttp3/internal/huc/OutputStreamRequestBody;->timeout()Lk/u;
    ...
    invoke-virtual {v1, v3, v4, v5}, Lk/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lk/u;
...
.method private static toHumanReadableAscii(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 5
    invoke-virtual {v6, p0, v1, v2}, Lk/c;->C0(Ljava/lang/String;II)Lk/c;

    const/16 v1, 0x3f

    .line 6
    invoke-virtual {v6, v1}, Lk/c;->D0(I)Lk/c;
    ...
    .line 9
    :goto_2
    invoke-virtual {v6, v7}, Lk/c;->D0(I)Lk/c;

    goto :goto_1

    .line 10
    :cond_2
    invoke-virtual {v6}, Lk/c;->F0()Ljava/lang/String;

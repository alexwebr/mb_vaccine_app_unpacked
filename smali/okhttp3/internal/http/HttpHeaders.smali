...
# static fields
.field private static final QUOTED_STRING_DELIMITERS:Lk/f;

.field private static final TOKEN_DELIMITERS:Lk/f;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:Lk/f;
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lk/f;
...
.method private static parseChallengeHeader(Ljava/util/List;Lk/c;)V
    .locals 8
    ...
    .line 1
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->skipWhitespaceAndCommas(Lk/c;)Z

    .line 2
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->readToken(Lk/c;)Ljava/lang/String;
    ...
    .line 7
    invoke-static {p1, v4}, Lokhttp3/internal/http/HttpHeaders;->skipAll(Lk/c;B)I
    ...
    invoke-virtual {p1, v6, v7}, Lk/c;->q(J)B
    ...
    .line 21
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->readQuotedString(Lk/c;)Ljava/lang/String;
...
.method public static parseChallenges(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v2, v3}, Lk/c;->A0(Ljava/lang/String;)Lk/c;

    .line 5
    invoke-static {v0, v2}, Lokhttp3/internal/http/HttpHeaders;->parseChallengeHeader(Ljava/util/List;Lk/c;)V
...
.method private static readQuotedString(Lk/c;)Ljava/lang/String;
    .locals 12
    ...
    .line 3
    :goto_0
    sget-object v2, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:Lk/f;

    invoke-virtual {p0, v2}, Lk/c;->w(Lk/f;)J
...
.method private static readToken(Lk/c;)Ljava/lang/String;
    .locals 5

    .line 1
    :try_start_0
    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lk/f;

    invoke-virtual {p0, v0}, Lk/c;->w(Lk/f;)J
    ...
    .line 3
    invoke-virtual {p0, v0, v1}, Lk/c;->O(J)Ljava/lang/String;
...
.method private static skipAll(Lk/c;B)I
    .locals 3
    ...
    invoke-virtual {p0, v1, v2}, Lk/c;->q(J)B
...
.method private static skipWhitespaceAndCommas(Lk/c;)Z
    .locals 3

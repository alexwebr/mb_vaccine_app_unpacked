...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    invoke-virtual {p1}, Lk/f;->d()Ljava/lang/String;
...
.method private declared-synchronized send(Lk/f;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILk/f;)V
...
.method checkResponse(Lokhttp3/Response;)V
    ...
    .line 8
    invoke-virtual {v0}, Lk/f;->I()Lk/f;

    move-result-object v0

    invoke-virtual {v0}, Lk/f;->d()Ljava/lang/String;
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILk/f;J)V
...
.method public connect(Lokhttp3/OkHttpClient;)V
    ...
    .line 12
    invoke-interface {p1}, Lokhttp3/Call;->timeout()Lk/u;

    move-result-object p1

    invoke-virtual {p1}, Lk/u;->clearTimeout()Lk/u;
...
.method public initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Lk/d;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLk/d;Ljava/util/Random;)V
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Lk/e;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLk/e;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(Lk/f;)V
    .locals 1

    .line 2
    iget-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->listener:Lokhttp3/WebSocketListener;

    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lk/f;)V

    return-void
.end method

.method public declared-synchronized onReadPing(Lk/f;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Lk/f;)V
    .locals 0
...
.method declared-synchronized pong(Lk/f;)Z
    .locals 1
...
.method public send(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lk/f;I)Z
...
.method writeOneFrame()Z
    ...
    .line 16
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lk/f;)V
    ...
    iget-object v2, v2, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Lk/f;
    ...
    .line 21
    invoke-virtual {v0, v3, v4, v5}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Lk/s;
    ...
    .line 22
    invoke-interface {v0, v2}, Lk/d;->L0(Lk/f;)Lk/d;
    ...
    iget-object v4, v4, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Lk/f;

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILk/f;)V
...
.method writePingFrame()V
    ...
    :cond_2
    :try_start_1
    sget-object v1, Lk/f;->g:Lk/f;

    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lk/f;)V
    :try_end_1

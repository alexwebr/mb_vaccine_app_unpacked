...
.method public onMessage(Lokhttp3/WebSocket;Lk/f;)V
    ...
    .line 12
    invoke-interface {v0, p2, p1}, Lcom/facebook/react/modules/websocket/WebSocketModule$ContentHandler;->onMessage(Lk/f;Lcom/facebook/react/bridge/WritableMap;)V

    goto :goto_0

    .line 13
    :cond_0
    invoke-virtual {p2}, Lk/f;->d()Ljava/lang/String;

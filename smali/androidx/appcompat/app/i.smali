...
.field private static final sConstructorMap:Lb/e/g;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/i;->sConstructorMap:Lb/e/g;
...
.method private checkOnClickListener(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    .line 3
    invoke-static {p1}, Lb/g/m/t;->L(Landroid/view/View;)Z
...
.method private createViewByPrefix(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 1
    sget-object v0, Landroidx/appcompat/app/i;->sConstructorMap:Lb/e/g;
    ...
    .line 7
    sget-object p1, Landroidx/appcompat/app/i;->sConstructorMap:Lb/e/g;
...
.method final createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    .line 8
    :pswitch_1
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createSeekBar(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/t;
    ...
    .line 10
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createRatingBar(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/s;
    ...
    .line 12
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createMultiAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/o;
    ...
    .line 14
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/d;
    ...
    .line 16
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createCheckedTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/h;
    ...
    .line 18
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createRadioButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/r;
    ...
    .line 20
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createCheckBox(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/g;
    ...
    .line 22
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createImageButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/m;
    ...
    .line 24
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createSpinner(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/v;
    ...
    .line 26
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createEditText(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/k;
    ...
    .line 28
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/f;
    ...
    .line 32
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/i;->createTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/y;
